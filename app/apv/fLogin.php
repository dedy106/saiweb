    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(<?=$folder_assets?>/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" method="post" id="loginform" action="<?=$root_ser?>/apv/cLogin.php?fx=login">
                        <div style="text-align: center;"><img src="<?=$folderoot_assets?>/img/sakuaja/esaku-landscape.png" style="width: 150px;"></div>
                        <h3 class="box-title mb-2 mt-2 text-center">Sign In</h3>
