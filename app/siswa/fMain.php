...
//   $root=$_SERVER['REQUEST_SCHEME']."://"..$_SERVER['SERVER_NAME'];
    ...
    $root_ser2=$root."/server/apv";
    $root_app=$root."/siswa_main";
    $root_log=$root."/siswa";
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img id='imguser' src="<?=$root_upload?>/<?=$foto?>"  alt="user" class=""> <span class="hidden-md-down"><?=$_SESSION['namaUser']?> &nbsp;<i class="fa fa-angle-down"></i></span> </a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <!-- text-->
                                <a href="<?=$root_app?>/dashProfile" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
                                <!-- text-->
                    ...
                    <ul id="sidebarnav">
                        ...
                        <!-- <li class="nav-small-cap">--- DASHBOARD &amp; TABLE, FORM </li> -->
                            <?php
                                ...
                                where a.kode_klp = '$kode_menu' and (isnull(a.jenis_menu,'-') = '-' OR a.jenis_menu='samping') order by kode_klp, rowindex";
                                $rs=execute($sql);
