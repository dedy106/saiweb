    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(<?=$folder_assets?>/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" method="post" id="loginform" action="<?=$root_ser?>/siswa/cLoginMobile.php?fx=login">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#login-user').on('change', function(){
                ...
                $.ajax({
                    url: "<?=$root_ser?>/siswa/cLoginMobile.php?fx=getDaftarPP",
                    type: 'POST',
                    dataType: 'json',
                    data: {'nis': nis},
