...
?>
    <div class="container-fluid mt-3">
        <div class="row" id="form-view">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Data Jenis Penilaian
        ...
        <div class="row" id="form-tambah-data" style="display:none;">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form" id="form-tambah">
                            <h4 class="card-title mb-2">Data Jenis Penilaian
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-9">
                                    <input class="form-control" type="text" placeholder="Kode Jenis" id="id_pekerjaan" name="id_pekerjaan">
                                </div>
                            </div>
                            <div class="form-group row">
    ...
    var dataTable = $('#table-data').DataTable({
        ...
        'serverSide': true,
        'ajax': {
            'url': '<?=$root_ser?>/JenisPenilaian.php?fx=getView',
    ...
    $('#form-tambah-data').on('submit', '#form-tambah', function(e){
    e.preventDefault();
