...
?>
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="form" id="form-tambah">
                            <h4 class="card-title mb-2">Input Pekerjaan
    ...
    $('#form-view').on('click', '#btn-edit', function(){
        ...
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/Pekerjaan.php?fx=getEdit',
            dataType: 'json',
            async:false,
    ...
    var dataTable = $('#table-jenis').DataTable({
        ...
        'serverSide': true,
        'ajax': {
            'url': '<?=$root_ser?>/Pekerjaan.php?fx=getView',
    ...
    e.preventDefault();
        ...
        if(parameter==''){
            ...
            $.ajax({
                type: 'POST',
                url: '<?=$root_ser?>/Pekerjaan.php?fx=simpan',
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
            ...
            $.ajax({
                type: 'POST',
                url: '<?=$root_ser?>/Pekerjaan.php?fx=ubah',
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
