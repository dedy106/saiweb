    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(<?=$folder_assets?>/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" method="post" id="loginform" action="<?=$root_ser?>/dago/cLogin.php?fx=login">
                        <h3 class="box-title m-b-20 text-center">Sign In</h3>
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="text" id="login-user" placeholder="Username" name="nik" autofocus required></div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
