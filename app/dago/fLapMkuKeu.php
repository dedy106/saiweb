...
<script type="text/javascript">
    ...
    function getPeriode(){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/LapMkuKeu.php?fx=getPeriode2',
            dataType: 'json',
            async:false,
    ...
    function getPaket(periode=null){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/LapMkuKeu.php?fx=getPaket',
            dataType: 'json',
            async:false,
    ...
    function getJadwal(periode=null,paket=null){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/LapMkuKeu.php?fx=getJadwal',
            dataType: 'json',
            async:false,
    ...
    function getPeserta(periode=null,paket=null,jadwal=null,noreg=null){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/LapMkuKeu.php?fx=getPeserta',
            dataType: 'json',
            async:false,
    ...
    function getNoReg(periode=null,paket=null,jadwal=null){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/LapMkuKeu.php?fx=getNoReg',
            dataType: 'json',
            async:false,
    ...
    $('.card-body').on('submit', '#formFilter', function(e){
        ...
        xurl ="<?=$root?>/app/dago/rptMkuKeu.php";
    ...
    $('#modalEmail').on('submit','#formEmail',function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '<?=$root_ser?>/LapMkuKeu.php?fx=sendEmail',
            dataType: 'json',
            data: formData,
            async:false,
            contentType: false,
