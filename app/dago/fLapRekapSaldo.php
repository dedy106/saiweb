...
<script type="text/javascript">
    ...
    function getPeriode(){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/LapRekapSaldo.php?fx=getPeriode2',
            dataType: 'json',
            async:false,
    ...
    function getPaket(periode=null){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/LapRekapSaldo.php?fx=getPaket',
            dataType: 'json',
            async:false,
    ...
    function getJadwal(periode=null,paket=null){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/LapRekapSaldo.php?fx=getJadwal',
            dataType: 'json',
            async:false,
    ...
    function getPeserta(periode=null,paket=null,jadwal=null,noreg=null){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/LapRekapSaldo.php?fx=getPeserta',
            dataType: 'json',
            async:false,
    ...
    function getNoReg(periode=null,paket=null,jadwal=null){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/LapRekapSaldo.php?fx=getNoReg',
            dataType: 'json',
            async:false,
    ...
    $('.card-body').on('submit', '#formFilter', function(e){
        ...
        $formData.delete('kode_lokasi');
        $formData.append('kode_lokasi', kode_lokasi);
        
        $formData.delete('nik');
        $formData.append('nik', nik);
        xurl ="<?=$root?>/app/dago/rptRekapSaldo.php";
    ...
    $('#content-lap').on('click', '.tagihan', function(e){
        ...
        xurl ="<?=$root?>/app/dago/rptDetailTagihan.php";
        $('#content-lap').load(xurl);
        // drawLapReg(formData);
    });
    ...
    $('#content-lap').on('click', '.bayar', function(e){
        ...
        xurl ="<?=$root?>/app/dago/rptKartuPbyr.php";
        $('#content-lap').load(xurl);
        // drawLapReg(formData);
    });
    ...
    $('#content-lap').on('click', '.saldo', function(e){
        ...
        $formData.delete('param');
        $formData.append('param', param);
        xurl ="<?=$root?>/app/dago/rptDetailSaldo.php";
        $('#content-lap').load(xurl);
        // drawLapReg(formData);
    });
    ...
    $('#content-lap').on('click', '.reg', function(e){
        ...
        xurl ="<?=$root?>/app/dago/rptFormReg.php";
        $('#content-lap').load(xurl);
        // drawLapReg(formData);
    });
    ...
    $('#content-lap').on('click', '.byr', function(e){
        ...
        $formData.delete('back');
        $formData.append('back', back);
        xurl ="<?=$root?>/app/dago/rptPbyr.php";
        $('#content-lap').load(xurl);
        // drawLapReg(formData);
    });
    ...
    $('#modalEmail').on('submit','#formEmail',function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '<?=$root_ser?>/LapRekapSaldo.php?fx=sendEmail',
            dataType: 'json',
            data: formData,
            async:false,
            contentType: false,
