...
?>
    ...
    $('#form-view').on('click', '#btn-edit', function(){
        ...
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/Jenis.php?fx=getEdit',
            dataType: 'json',
            async:false,
    ...
    var dataTable = $('#table-jenis').DataTable({
        ...
        'serverSide': true,
        'ajax': {
            'url': '<?=$root_ser?>/Jenis.php?fx=getView',
    ...
    $('#form-view').on('click','#btn-delete',function(e){
        ...
        confirmButtonText: 'Yes, Dihapus!'
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: '<?=$root_ser?>/Jenis.php',
                    dataType: 'json',
                    async:false,
                    data: {'kode_jenis':kode,'kode_lokasi':kode_lokasi},
                    success:function(result){
                        if(result.status){
    ...
    e.preventDefault();
        ...
        if(parameter==''){
            ...
            $.ajax({
                type: 'POST',
                url: '<?=$root_ser?>/Jenis.php?fx=ubah',
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
