...
<link href="<?=$folder_css?>/custom.css" rel="stylesheet">
            ...
            <div class="col-sm-12" style="height: 90px;">
                <div class="card">
                    <div class="card-body pb-0">
                        <h4 class="card-title mb-4"><i class='fas fa-cube'></i> Form Karyawan
    ...
    $('#nik,#nama,#email,#no_telp,#file_gambar').keydown(function(e){
        var code = (e.keyCode ? e.keyCode : e.which);
        var nxt = ['nik','nama','email','no_telp','file_gambar'];
        if (code == 13 || code == 40) {
            e.preventDefault();
