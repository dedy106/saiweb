        ...
        <div class="col-sm-12">
            <div class="card " id="sai-rpt-filter-box">
                <div class="card-header with-border">
                    <h3 class="card-title" style="position:absolute"><i class="fa fa-file-text-o"></i> Laporan Penjualan</h3>
...
function terbilang(int){
    ...
    function drawLapPNJ(formData){
        ...
        saiPost('<?=$root_ser?>/Laporan.php?fx=getLapPNJ', null, formData, null, function(data){
