...
?>
    <div class="container-fluid mt-3">
        <div class="row" id="saku-datatable">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4"><i class='fas fa-cube'></i> Data Unit
                    ...
                    <div class="card-body table-responsive pt-0" style='height:450px'>
                            <form class="form" id="form-tambah" style='margin-bottom:100px'>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-3">
                                        <input class="form-control" type="text" placeholder="Kode Kelompok" id="kode_pp" name="kode_pp" required >
                                    </div>
                                </div>
                                <div class="form-group row">
    ...
    var dataTable = $('#table-data').DataTable({
        ...
        'serverSide': true,
        'ajax': {
            'url': '<?=$root_ser?>/Unit.php?fx=getView',
