                    ...
                    <div class='col-xs-12'>
                        <div class='box' style='padding:0'>
                            <div class='box-body'>
                                ...
                                </a><a href='$root_app/fPembelian2' class='btn btn-secondary' id='btnBack'><i class='fa fa-arrow-left'></i> Close </a>
                            </div>
                        </div>
                    </div>
                </div>";
...
function printNota(){
    window.open(root+'/fNotaBeli/?param='+no_bukti+'&print=1','_blank'); 
}
