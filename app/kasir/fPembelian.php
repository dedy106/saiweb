                        ...
                        <div class='col-md-12'>
                            <table class='table' style='margin-bottom: 5px'>
                                <tr>
                                    ...
                                    <input type='text' class='form-control' placeholder="Barcode [ctrl+b]" id="kd-barang2" >
                                    </td>
                                    <td style='padding: 3px;width:25%' colspan='2'>
...
<script>
    ...
    $('#edit-submit').click(function(e){
        ...
        input += "<td width='15%' style='text-align:right'>"+toRp(hrg)+"<input type='hidden' name='harga_barang[]' class='change-validation inp-hrgb'  value='"+toRp(hrg)+"' readonly required></td>";
        input += "<td width='5%' style='text-align:right'>"+setSatuan(kd)+"<input type='hidden' name='satuan_barang[]' class='change-validation inp-satuanb'  value='"+setSatuan(kd)+"' readonly required><input type='hidden' name='kode_akun[]' class='change-validation inp-satuanb'  value='"+setAkun(kd)+"' readonly></td>";
