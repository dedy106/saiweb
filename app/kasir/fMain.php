    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            ...
                            ?>
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?=$root?>/upload/<?=$foto?>"  alt="user" class=""> <span class="hidden-md-down"><?=$_COOKIE['namaUser']?> &nbsp;<i class="fa fa-angle-down"></i></span> </a>
        ...
        <div class="page-wrapper" style="min-height: 600px !important;">
            ...
            <script>
                ...
                if(form !="" || form != "-"){
                    loadForm("<?=$root?>/app/kasir/"+form+".php")
                }

                $('.dropdown-menu').on('click','#seeProfile',function(e){
                    loadForm("<?=$root?>/app/kasir/fProfile.php");
                });
                ...
                $('.sidebar-nav').on('click','.a_link',function(e){
                    ...
                    if(tmp[4] == "" || tmp[4] == "-"){
                        ...
                        loadForm("<?=$root?>/app/kasir/"+tmp[4]+".php");
                    }
                    // alert(tmp[4]);
                });
            </script>
