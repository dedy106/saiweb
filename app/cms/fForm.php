...
?>
    ...
    $('#saku-datatable').on('click', '#btn-edit', function(){
        ...
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/Form.php?fx=getEdit',
            dataType: 'json',
            async:false,
            ...
            success:function(result){
                if(result.status){
                    $('#id_edit').val('edit');
                    $('#kode_form').val(id);
                    $('#nama_form').val(result.daftar[0].nama_form);
    ...
    $('#form-tambah').on('change', '#kode_form', function(){
        var id= $(this).val();
    ...
    e.preventDefault();
        ...
        if(parameter==''){
            ...
            $.ajax({
                type: 'POST',
                url: '<?=$root_ser?>/Form.php?fx=simpan',
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
