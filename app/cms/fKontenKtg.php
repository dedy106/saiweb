...
?>
    <div class="container-fluid mt-3">
        <div class="row" id="saku-datatable">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4"><i class='fas fa-cube'></i> Data Kategori Galeri
                    ...
                    <div class="card-body table-responsive pt-0" style='height:460px'>
                            <form class="form" id="form-tambah" style='margin-bottom:100px'>
                                ...
                                <div class="form-group row">
                                    <div class="col-3">
                                        <input class="form-control" type="hidden" placeholder="Kode Kategori" id="kode_ktg" name="kode_ktg" required >
                                    </div>
                                </div>
                                <div class="form-group row">
    ...
    $('#saku-datatable').on('click', '#btn-edit', function(){
        ...
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/KontenKtg.php?fx=getEdit',
            dataType: 'json',
            async:false,
    ...
    var dataTable = $('#table-data').DataTable({
        ...
        'serverSide': true,
        'ajax': {
            'url': '<?=$root_ser?>/KontenKtg.php?fx=getView',
    ...
    e.preventDefault();
        ...
        if(parameter==''){
            ...
            $.ajax({
                type: 'POST',
                url: '<?=$root_ser?>/KontenKtg.php?fx=simpan',
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
            ...
            $.ajax({
                type: 'POST',
                url: '<?=$root_ser?>/KontenKtg.php?fx=ubah',
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
    ...
    $('#kode_ktg,#nama').keydown(function(e){
        var code = (e.keyCode ? e.keyCode : e.which);
        var nxt = ['kode_ktg','nama'];
        if (code == 13 || code == 40) {
            e.preventDefault();
