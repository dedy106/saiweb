...
<link href="<?=$folder_css?>/custom.css" rel="stylesheet">
    ...
    $('#saku-datatable').on('click', '#btn-edit', function(){
        ...
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/StatusSiswa.php?fx=getEdit',
            dataType: 'json',
            async:false,
            data: {'kode_ss':id,'kode_lokasi':kode_lokasi,'kode_pp':kode_pp},
            success:function(result){
                if(result.status){
                    $('#id_edit').val('edit');
                    $('#kode_ss').val(id);
    ...
    $('#saku-datatable').on('click','#btn-delete',function(e){
        ...
        confirmButtonText: 'Yes, Dihapus!'
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: '<?=$root_ser?>/StatusSiswa.php',
                    dataType: 'json',
                    async:false,
                    data: {'kode_ss':kode,'kode_lokasi':kode_lokasi,'kode_pp':kode_pp},
                    success:function(result){
                        if(result.status){
    ...
    e.preventDefault();
        ...
        if(parameter==''){
            ...
            $.ajax({
                type: 'POST',
                url: '<?=$root_ser?>/StatusSiswa.php?fx=simpan',
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
            ...
            $.ajax({
                type: 'POST',
                url: '<?=$root_ser?>/StatusSiswa.php?fx=ubah',
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
