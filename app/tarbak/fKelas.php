...
<link href="<?=$folder_css?>/custom.css" rel="stylesheet">
    ...
    var dataTable = $('#table-data').DataTable({
        ...
        "order": [[0, "asc"],[3, "asc"]],
        'ajax': {
            'url': '<?=$root_ser?>/Kelas.php?fx=getView',
   ...
   function getPP(){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/Kelas.php?fx=getPP',
            dataType: 'json',
            async:false,
    ...
    function getTingkat(){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/Kelas.php?fx=getTingkat',
            dataType: 'json',
            async:false,
            data: {'kode_lokasi':'<?=$kode_lokasi?>'},
            success:function(result){    
    ...
    function getJurusan(id=null){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/Kelas.php?fx=getJurusan',
            dataType: 'json',
            async:false,
    ...
    $('#saku-datatable').on('click', '#btn-edit', function(){
        ...
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/Kelas.php?fx=getEdit',
            dataType: 'json',
            async:false,
            data: {'kode_kelas':id,'kode_lokasi':kode_lokasi,'kode_pp':kode_pp},
            success:function(result){
                if(result.status){
                    $('#id').val('edit');
                    $('#kode_kelas').val(id);
    ...
    $('#saku-datatable').on('click','#btn-delete',function(e){
        ...
        confirmButtonText: 'Yes, Dihapus!'
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: '<?=$root_ser?>/Kelas.php',
                    dataType: 'json',
                    async:false,
                    data: {'kode_kelas':kode,'kode_lokasi':kode_lokasi,'kode_pp':kode_pp},
                    success:function(result){
                        if(result.status){
    ...
    e.preventDefault();
        ...
        if(parameter==''){
            ...
            $.ajax({
                type: 'POST',
                url: '<?=$root_ser?>/Kelas.php?fx=simpan',
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
            ...
            $.ajax({
                type: 'POST',
                url: '<?=$root_ser?>/Kelas.php?fx=ubah',
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
