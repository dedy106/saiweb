...
?>
    ...
    function getPP(){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/Angkatan.php?fx=getPP',
            dataType: 'json',
            async:false,
    ...
    function getTingkat(){
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/Angkatan.php?fx=getTingkat',
            dataType: 'json',
            async:false,
            data: {'kode_lokasi':'<?=$kode_lokasi?>'},
            success:function(result){    
    ...
    $('#saku-form').on('click', '#btn-edit', function(){
        ...
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/Angkatan.php?fx=getEdit',
            dataType: 'json',
            async:false,
            data: {'kode_akt':id,'kode_lokasi':kode_lokasi,'kode_pp':kode_pp},
            success:function(result){
                if(result.status){
                    $('#id_edit').val('edit');
                    $('#kode_akt').val(id);
    ...
    $('#saku-form').on('click','#btn-delete',function(e){
        ...
        confirmButtonText: 'Yes, Dihapus!'
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: '<?=$root_ser?>/Angkatan.php',
                    dataType: 'json',
                    async:false,
                    data: {'id_pekerjaan':kode,'kode_lokasi':kode_lokasi,'kode_pp':kode_pp},
                    success:function(result){
                        if(result.status){
    ...
    e.preventDefault();
        ...
        if(parameter==''){
            ...
            $.ajax({
                type: 'POST',
                url: '<?=$root_ser?>/Angkatan.php?fx=simpan',
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
            ...
            $.ajax({
                type: 'POST',
                url: '<?=$root_ser?>/Angkatan.php?fx=ubah',
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
