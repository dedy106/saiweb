<?php
    ...
    $root_ser="http://".$_SERVER['SERVER_NAME']."/server/dash";
    $root_app="http://".$_SERVER['SERVER_NAME']."/dash_main";
    $root_log="http://".$_SERVER['SERVER_NAME']."/dash";
    $root_print="http://".$_SERVER['SERVER_NAME']."/dash_preview";
