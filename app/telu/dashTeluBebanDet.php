...
<div class="container-fluid mt-3">
    ...
    <div class="row mt-2" >
        <div class="col-12">
            <div class="card">
                <h5>Pertumbuhan Beban per Fakultas</h5>
                                    ...
                                    point: {
                                        events: {
                                            click: function() {  
                                                ...
                                                // alert($kd2);
                                                loadForm("<?=$root?>/app/telu/dashTeluBebanDet2.php");
                                            }
                                        }
                                    }
                                }
...
function initDash(){
    loadService('pertumbuhan','GET','<?=$root_ser?>/dashTeluBebanDet.php?fx=getPertumbuhan','<?=$kode_lokasi?>|'+$kd); 
    loadService('BebanFak','GET','<?=$root_ser?>/dashTeluBebanDet.php?fx=getPertumbuhan','<?=$kode_lokasi?>|'+$kd); 
    loadService('tableBeban','GET','<?=$root_ser?>/dashTeluBebanDet.php?fx=getTableBeban','<?=$kode_lokasi?>|'+$kd); 
...
$('.container-fluid').on('click','#btnBack',function(e){
    console.log($kd);
    loadForm("<?=$root?>/app/telu/dashTeluBeban.php");
})
</script>