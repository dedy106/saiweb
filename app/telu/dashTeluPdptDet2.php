...
function initDash(){
    loadService('pdptJur','GET','<?=$root_ser?>/dashTeluPdptDet2.php?fx=getPdptJur','<?=$kode_lokasi?>|'+$kd+'|'+$kd2); 
    loadService('tablePend','GET','<?=$root_ser?>/dashTeluPdptDet2.php?fx=getTablePendJur','<?=$kode_lokasi?>|'+$kd+'|'+$kd2); 
