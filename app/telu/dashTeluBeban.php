...
function initDash(){
    loadService('komposisi','GET','<?=$root_ser?>/dashTeluBeban.php?fx=getKomposisi','<?=$kode_lokasi?>|'); 
    loadService('rkaVSreal','GET','<?=$root_ser?>/dashTeluBeban.php?fx=perRKAvsReal','<?=$kode_lokasi?>|'); 
    loadService('totalOprNon','GET','<?=$root_ser?>/dashTeluBeban.php?fx=getTotalOprNon','<?=$kode_lokasi?>|'); 
