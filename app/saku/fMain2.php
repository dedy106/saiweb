...
<head>
    ...
    <style>
        ...
        .topbar .navbar-collapse{
            box-shadow: 3px 2px 2px 2px #00000029;
        ...
        .topbar .top-navbar .navbar-header .h6{
            line-height:55px !important;
        }
        ...
        .mini-sidebar .nama-perusahaan > h4{
            line-height:65px;
        }
    </style>
    ...
    <div id="main-wrapper">
        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <!-- Logo -->
                <!-- ============================================================== -->
                <div class="navbar-header" style="background: #F0F0F0;">
                    <a class="navbar-brand" href="http://saiweb.simkug.com/saku_main/" style="color: black;position:absolute;width: 30px;top: 0;">
                    <i class="fas fa-th-large" style="color:#007AFF;font-size: 25px;"></i>
                    
                    </a>
                    <h6 style="padding-left: 35px;margin-bottom: 0;font-weight: bold;padding-top: 10px;">Januari 2020</h6>
                    
                    <h6 style="padding-left: 35px;font-size: 11px;">Lokasi : 99</h6>
                    <a href="#" style="color: black;position:absolute;width: 30px;left: 210px;top: 0;" class="navbar-brand2" id='sidebartoggler2' >
                    <i class="fas fa-arrow-circle-left" style="color:#AFAFAF;font-size: 25px;"></i>
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item"> <a id='sidebartoggler' class="nav-link sidebartoggler d-none d-lg-block d-md-block waves-effect waves-dark ndisplay" href="javascript:void(0)"><i class="icon-menu"></i></a> </li>
                        <!-- ============================================================== -->
                        <!-- Search -->
                        <!-- ============================================================== -->
                        <!-- <li class="nav-item">
                        ...
                        <li class="nav-item pl-3 nama-perusahaan">
                            <h4 style="margin-bottom: 0;">PT Samudra Aplikasi Indonesia</h4>
                        </li>
                    </ul>
                    <!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            <script>
                ...
                if(form !="" || form != "-"){
                    loadForm("<?=$root?>/app/saku/"+form+".php")
                }
                ...
                $('.sidebar-nav').on('click','.a_link',function(e){
                    ...
                    if(tmp[4] == "" || tmp[4] == "-"){
                        ...
                        loadForm("<?=$root?>/app/saku/"+tmp[4]+".php");
                    }
                    // alert(tmp[4]);
                });

                $('#sidebartoggler2').click(function(e){
                    e.preventDefault();
                ...
                $('#sidebartoggler').click(function(e){
                    if($(".sidebartoggler").hasClass("ndisplay")){
                        $(".sidebartoggler").removeClass("ndisplay");
                        $(".sidebartoggler").addClass("display");
                    }else if($(".sidebartoggler").hasClass("display")){
                        $(".sidebartoggler").removeClass("display");
                        $(".sidebartoggler").addClass("ndisplay");
                    }
                });
            </script>
        </div>
