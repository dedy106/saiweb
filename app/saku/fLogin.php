...
<html>
    <head>
        ...
        <style>
            ...
            #buttonPass {
                background-image: url('<?=$root?>/assets/img/hide.png');
    ...
    <body>
        ...
        <section>
            <div class="wrapper row">
                <div class="top col-md-8">
                    <h4 style='text-align:left'>Hi, Selamat Pagi</h4>
            ...
            <div class="wrapper2">
            <form id='form-login' method="post" action="<?=$root_ser?>/saku/cLogin.php?fx=login" >
                <div class="top">
                <h2><u>Masuk</u>
                ...
                <div class="mid" style="padding:10px">
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <input type="text" id="username" autocomplete="off" placeholder="username" name="nik" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12" style='z-index:0;'><input type="password" id="myPass" placeholder="password" name="pass" required>
                        </div>
                        <div class="col-md-2 px-0" style='z-index:1;top: -30px;left: 230px;'><button type="button" name="button" onclick="showPass()" id="buttonPass"></button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
        ...
        <script>
            ...
            function showPass() {
                ...
                if (x.type === "password") {
                    x.type = "text";
                    document.getElementById("buttonPass").style.backgroundImage = "url('<?=$root?>/assets/img/view.png')";
                    // document.getElementById("myPass").style.paddingLeft = "30px";
