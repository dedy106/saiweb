            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                        ...
                        <li class="pull-left header"><i class="fa fa-inbox"></i> Data Development</li>        
                    </ul>
                                ...
                                <div class="col-xs-12">
                                    <div class="box" style="border-top:none;">
                                        ...
                                        <div class="box-body sai-container-overflow-x">
                                            <table class='table table-bordered' id='table-Development' style='width:100%'>
                                                <thead>
                                                    <th>No Bukti</th>
                                                    <th>No Ref</th>
                                                    <th>Tanggal</th>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box" style="border-top:none;">
                                        ...
                                        <div class="box-body sai-container-overflow-x">
                                            <table class='table table-bordered' id='table-Development-keep' style='width:100%'>
                                                <thead>
                                                    <th>No Bukti</th>
                                                    <th>No Ref</th>
                                                    <th>Tanggal</th>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box" style="border-top:none;">
                                        ...
                                        <div class="box-body sai-container-overflow-x">
                                            <table class='table table-bordered' id='table-Development-finish' style='width:100%'>
                                                <thead>
                                                    <th>No Bukti</th>
                                                    <th>No Ref</th>
                                                    <th>Tanggal</th>
    ...
    <form id='web_form_insert' hidden enctype="multipart/form-data">
      <div class='row'>
        <div class='col-xs-12'>
          <div class='box'>
            <div class='box-header'>
              <h3 class="box-title" ><i class="fa fa-inbox"></i> Input Development</h3> 
...
function getJenisDok(){
    $.ajax({
        type: 'GET',
        url: '<?=$root_ser?>/Development.php?fx=getJenisDok',
        dataType: 'json',
        data: {},
        success:function(result){    
            if(result.status){
...
$(document).ready(function(){
  ...
  var dataTable = $('#table-Development').DataTable({
      'processing': true,
      'serverSide': true,
      'ajax': {
          'url': '<?=$root_ser?>/Development.php?fx=getDatatable',
          'data': {'jenis':'new'},
          'type': 'POST',
  ...
  var dataTable2 = $('#table-Development-keep').DataTable({
      'processing': true,
      'serverSide': true,
      'ajax': {
          'url': '<?=$root_ser?>/Development.php?fx=getDatatable',
  ...
  var dataTable3 = $('#table-Development-finish').DataTable({
      'processing': true,
      'serverSide': true,
      'ajax': {
          'url': '<?=$root_ser?>/Development.php?fx=getDatatable',
  ...
  $('#saiweb_container').on('click', '.web_datatable_edit', function(){
     ...
     if(jenis == 'new'){
        ...
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/Development.php?fx=getEditDevelopment',
            dataType: 'json',
