            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                        ...
                        <li class="pull-left header"><i class="fa fa-inbox"></i> Data Kontrak</li>        
                    </ul>
                                ...
                                <div class="col-xs-12">
                                    <div class="box" style="border-top:none;">
                                        ...
                                        <div class="box-body sai-container-overflow-x">
                                            <table class='table table-bordered' id='table-Kontrak' style='width:100%'>
                                                <thead>
                                                    <th>No Bukti</th>
                                                    <th>No Ref</th>
                                                    <th>Tanggal</th>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box" style="border-top:none;">
                                        ...
                                        <div class="box-body sai-container-overflow-x">
                                            <table class='table table-bordered' id='table-Kontrak-keep' style='width:100%'>
                                                <thead>
                                                    <th>No Bukti</th>
                                                    <th>No Ref</th>
                                                    <th>Tanggal</th>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box" style="border-top:none;">
                                        ...
                                        <div class="box-body sai-container-overflow-x">
                                            <table class='table table-bordered' id='table-Kontrak-finish' style='width:100%'>
                                                <thead>
                                                    <th>No Bukti</th>
                                                    <th>No Ref</th>
                                                    <th>Tanggal</th>
    ...
    <form id='web_form_insert' hidden enctype="multipart/form-data">
      <div class='row'>
        <div class='col-xs-12'>
          <div class='box'>
            <div class='box-header'>
              <h3 class="box-title" ><i class="fa fa-inbox"></i> Input Kontrak</h3> 
          ...
          <div class='box box-warning'>
            <div class='box-body pad'> 
              ...
              <div class='row'>
                <div style="margin-bottom:5px;padding-right: 0px;padding-left: 0px;" class="form-group col-md-6">
                    <label class="control-label col-sm-6">Tanggal</label>
                    <div style="padding-right:15px; padding-left:15px;" class="input-group date col-sm-6">
                ...
                <div style="margin-bottom:5px;padding-right: 0px;padding-left: 0px;" class="form-group col-md-6">
                    <label class="control-label col-sm-6">Tgl Selesai</label>
                    <div style="padding-right:15px; padding-left:15px;" class="input-group date col-sm-6">
                        <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                        </div>
                        <input name="tgl_selesai" class="form-control datepicker-dmy" id="tgl_selesai" value="<?php echo date('d-m-Y'); ?>" required="">
                    </div>                    
                </div>
              </div>
              <div class='row'>
...
function getJenisDok(){
    $.ajax({
        type: 'GET',
        url: '<?=$root_ser?>/Kontrak.php?fx=getJenisDok',
        dataType: 'json',
        data: {},
        success:function(result){    
            if(result.status){
...
$(document).ready(function(){
  ...
  var dataTable = $('#table-Kontrak').DataTable({
      'processing': true,
      'serverSide': true,
      'ajax': {
          'url': '<?=$root_ser?>/Kontrak.php?fx=getDatatable',
          'data': {'jenis':'new'},
          'type': 'POST',
      ...
      'columnDefs': [
          {'targets': 10, 'className': 'text-center',data: null, 'defaultContent': action_html },
          {
                'targets': 7,
  ...
  var dataTable2 = $('#table-Kontrak-keep').DataTable({
      'processing': true,
      'serverSide': true,
      'ajax': {
          'url': '<?=$root_ser?>/Kontrak.php?fx=getDatatable',
      ...
      'columnDefs': [
          {'targets': 11, 'className': 'text-center', 'defaultContent': action_html2 },
          {
                'targets': 8,
                'className': 'text-right',
                'render': $.fn.dataTable.render.number( '.', ',', 0, 'Rp. ' )
  ...
  var dataTable3 = $('#table-Kontrak-finish').DataTable({
      'processing': true,
      'serverSide': true,
      'ajax': {
          'url': '<?=$root_ser?>/Kontrak.php?fx=getDatatable',
  ...
  $('#saiweb_container').on('click', '.web_datatable_edit', function(){
     ...
     if(jenis == 'new'){
        ...
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/Kontrak.php?fx=getEditKontrak',
            dataType: 'json',
            ...
            success:function(res){
                if(res.status){
                    ...
                    $('#tgl_selesai').val(line.tgl_selesai);
