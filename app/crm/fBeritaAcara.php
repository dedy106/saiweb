            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                        ...
                        <li class="pull-left header"><i class="fa fa-inbox"></i> Data Berita Acara</li>        
                    </ul>
                                ...
                                <div class="col-xs-12">
                                    <div class="box" style="border-top:none;">
                                        ...
                                        <div class="box-body sai-container-overflow-x">
                                            <table class='table table-bordered' id='table-BeritaAcara' style='width:100%'>
                                                <thead>
                                                    <th>No Bukti</th>
                                                    <th>No Ref</th>
                                                    <th>Tanggal</th>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box" style="border-top:none;">
                                        ...
                                        <div class="box-body sai-container-overflow-x">
                                            <table class='table table-bordered' id='table-BeritaAcara-keep' style='width:100%'>
                                                <thead>
                                                    <th>No Bukti</th>
                                                    <th>No Ref</th>
                                                    <th>Tanggal</th>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box" style="border-top:none;">
                                        ...
                                        <div class="box-body sai-container-overflow-x">
                                            <table class='table table-bordered' id='table-BeritaAcara-finish' style='width:100%'>
                                                <thead>
                                                    <th>No Bukti</th>
                                                    <th>No Ref</th>
                                                    <th>Tanggal</th>
    ...
    <form id='web_form_insert' hidden enctype="multipart/form-data">
      <div class='row'>
        <div class='col-xs-12'>
          <div class='box'>
            <div class='box-header'>
              <h3 class="box-title" ><i class="fa fa-inbox"></i> Input BeritaAcara</h3> 
...
function getJenisDok(){
    $.ajax({
        type: 'GET',
        url: '<?=$root_ser?>/BeritaAcara.php?fx=getJenisDok',
        dataType: 'json',
        data: {},
        success:function(result){    
            if(result.status){
...
$(document).ready(function(){
  ...
  var dataTable = $('#table-BeritaAcara').DataTable({
      'processing': true,
      'serverSide': true,
      'ajax': {
          'url': '<?=$root_ser?>/BeritaAcara.php?fx=getDatatable',
          'data': {'jenis':'new'},
          'type': 'POST',
  ...
  var dataTable2 = $('#table-BeritaAcara-keep').DataTable({
      'processing': true,
      'serverSide': true,
      'ajax': {
          'url': '<?=$root_ser?>/BeritaAcara.php?fx=getDatatable',
  ...
  var dataTable3 = $('#table-BeritaAcara-finish').DataTable({
      'processing': true,
      'serverSide': true,
      'ajax': {
          'url': '<?=$root_ser?>/BeritaAcara.php?fx=getDatatable',
  ...
  $('#saiweb_container').on('click', '.web_datatable_edit', function(){
     ...
     if(jenis == 'new'){
        ...
        $.ajax({
            type: 'GET',
            url: '<?=$root_ser?>/BeritaAcara.php?fx=getEditBeritaAcara',
            dataType: 'json',
