...
<html>
    <head>
        ...
        <style>
            ...
            .button-del {
                background: url('img/del-tran.png') no-repeat;
                background-size: 100%;
                /* <img src="img/add.png" width="18%"> */
                width: 20%;
                height: 21px;
    ...
    <body>
        ...
        <section>
            <div class="wrapper">
                <div class="top">
                    <h4>Kode Akun</h4>
                    Kami menyiapkan kode akun yang <br>
                    dibutuhkan untuk bisnis Anda. Anda <br>
                    dapat mengatur sendiri atau langsung <br>
                ...
                <div class="bottom">
                    <div class="row">
                        <div class="col">
                            ...
                            <a class="pa2">2. Pilih Kelompok Akun</a> <img src="img/sukses.png" width="3%" hidden> <br>
            ...
            <div class="wrapper2">
                ...
                <div class="bottom">
                    <button class="button1 py-2" onclick="window.location.href = 'fDaper.php';">Back</button>
                    <button class="button2 py-2" onclick="window.location.href = 'fSala.php';">Next</button>
                </div>
            </div>
            <div>
		                    ...
		                    if(typeof result.daftar !== 'undefined' && result.daftar.length>0){
		                        for(i=0;i<result.daftar.length;i++){
                                    ...
                                    html+=  "<tr>"+
                                                ...
                                                "<td style='text-align: center;'><button class='button-add'></button></td>"+
                                            "</tr>"+
                                            "<tr>"+
                                                "<td scope='row'>"+result.daftar[i].kode_akun+"</td>"+
                                                "<td>"+result.daftar[i].nama+"</td>"+
                                                "<td width='30%' style='text-align: center;'><button class='button-edit mr-3'></button><button class='button-del'></button></td>"+
                                            "</tr>";
                                    $('#dataYa').html(html);
		                        }
		                    }
