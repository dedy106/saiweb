...
//   $root="http://".$_SERVER['SERVER_NAME'];
    ...
    $root_app="http://".$_SERVER['SERVER_NAME']."/elite_main";
    $root_log="http://".$_SERVER['SERVER_NAME']."/elite";
    // $folder_img=$root."/web/img";

    // $root_ser="http://".$_SERVER['SERVER_NAME']."/web/server";

    // $root=$_SERVER["DOCUMENT_ROOT"];
    // $root_app="http://".$_SERVER['SERVER_NAME']."/web/app/elite";
    // $root_ser="http://".$_SERVER['SERVER_NAME']."/web/server/elite";
    // $folder_css=$root."/web/app/elite/src/dist/css";
    // $folder_js=$root."/web/app/elite/src/dist/js";
    // $folder_assets=$root."/web/app/elite/assets";
...
<head>
    ...
    <!-- Tiny Editor -->
    <script src="https://cdn.tiny.cloud/1/z4pi3l707l3x0t5e7sgkkgtoisaws400f7daaod63y90adjx/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <!-- <li class="nav-small-cap">--- DASHBOARD &amp; TABLE, FORM </li> -->
                            <?php
                                ...
                                where a.kode_klp = 'CMS2' and isnull(a.jenis_menu,'-') = '-' order by kode_klp, rowindex";
                                $rs=execute($sql);
                            ...
                            //                     </span>
                                    ...
                                    if($this_lv == 0 AND $next_lv == 0){
                                        echo " 
                                        <li >
                                            <a href='$this_link' class='waves-effect waves-dark'>
                                        ...
                                        echo " 
                                        <li class='treeview'>
                                            <a href='$this_link' class='has-arrow waves-effect waves-dark' aria-expanded='false'>
