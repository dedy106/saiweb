<?php
    ...
    // $folder_node=$root."/web/app/elite/assets/node_modules";
    // $folder_assets=$root."/web/app/elite/assets";
    // $folder_img=$root."/web/img";
    $root_ser="http://".$_SERVER['SERVER_NAME']."/web/server";
    // $root=$_SERVER["DOCUMENT_ROOT"];
    $folder_css=$root."/web/asset_elite/dist/css";
    $folder_js=$root."/web/asset_elite/dist/js";
    $folder_assets=$root."/web/asset_elite";
    $folder_upload=$root."/web/asset_elite/upload";
?>
    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(<?=$folder_assets?>/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" method="post" id="loginform" action="<?=$root_ser?>/elite/cLogin.php?fx=login">
