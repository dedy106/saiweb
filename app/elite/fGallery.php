            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" id="btn-galeri-tambah" class="btn btn-info ml-2" style="float:right;"><i class="fa fa-plus-circle"></i> Tambah Galeri</button>
                        </h4>
