...
//   $root="http://".$_SERVER['SERVER_NAME'];
    ...
    $nik=$_COOKIE['userLog'];
    $root_ser="http://".$_SERVER['SERVER_NAME']."/server/kasir";
    $root_app="http://".$_SERVER['SERVER_NAME']."/kasir_main";
    $root_log="http://".$_SERVER['SERVER_NAME']."/kasir";
    $root_print="http://".$_SERVER['SERVER_NAME']."/kasir_preview";
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <section class="content" id='ajax-content-section'>
                    ...
                    <table class="gridexample table table-bordered table-striped">
					<thead>
						<tr>
							<th></th>
							<th>A</th>
