<?php
    ...
    $root_ser=$root."/server/belajar";
    $root_app=$root."/belajar_main";
    $root_log=$root."/belajar";
    $root_print=$root."/belajar_preview";
...
<body class="skin-default fixed-layout">
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                ...
                                <!-- text-->
                                <a href="<?=$root_ser?>/Login.php?fx=logout" class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a>
                                <!-- text-->
                            </div>
                        </li>
                        <!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            <div class='wrap-element'><iframe id="myframe" class='wrapped-iframe'><h3>INI Iframe</h3></iframe>
            <!-- <div id="box" style='border:1px solid blue'>
                <h2>Ini DIV</h2>
            </div> -->
            </div>
            <button id='btnAct' type='button' class='btn btn-primary' >Update</button>
            </section>
        </div>
        ...
        function updateIframe(){
            ...
            // myFrame.html(html);
            $("#myframe").attr("src", "<?=$root?>/app/test/show.php");
            // $('#box').load("<?=$root?>/app/test/show.php");
        }

        $('#ajax-content-section').on('click','#btnAct',function(e){
            e.preventDefault();
            updateIframe();
            // alert('ok');
        });
...
<?php
    ...
    //         window.location='$root_log/fLogin.php';
    //         </script>";
    //     }else{
