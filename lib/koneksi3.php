...
function db_Connect() { 
	...
	include_once($root."config/dbSetting3.php");
	global $host;
	global $user;
	global $pass;
	global $database;
...
function qstr2($string){
    return db_Connect2()->qstr($string);
}
