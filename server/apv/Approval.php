<?php
    ...
    function getPengajuan(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            where a.kode_lokasi='$kode_lokasi' and a.status='1' and a.sts_ver='1' and a.kode_jab='".$_SESSION['kode_jab']."' ";
    ...
    function getApproval(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            where a.kode_lokasi='$kode_lokasi' and b.status='2' and b.kode_jab='".$_SESSION['kode_jab']."' and a.modul='JK' ";
    ...
    function simpan(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $sql1= "insert into apv_pesan (no_bukti,kode_lokasi,keterangan,tanggal,no_urut,status,modul) values ('".$data['no_aju']."','".$kode_lokasi."','".$data['keterangan']."','".$data['tanggal']."',".$data['nu'].",'".$data['status']."','JK') ";
            
            array_push($exec,$sql1);
            
            $upd = "update apv_flow set status ='".$data['status']."',tgl_app='".$data['tanggal']."' where no_bukti='".$data['no_aju']."' and no_urut=".$data['nu']." and kode_lokasi='$kode_lokasi' ";
            array_push($exec,$upd);

            $max = dbRowArray("select max(no_urut) as nu from apv_flow where no_bukti='".$data['no_aju']."' and kode_lokasi='$kode_lokasi' ");

            $min = dbRowArray("select min(no_urut) as nu from apv_flow where no_bukti='".$data['no_aju']."' and kode_lokasi='$kode_lokasi' ");

            if($data['status'] == 2){
                $nu=$data['nu']+1;
                $upd2 = "update apv_flow set status ='1' ,tgl_app='".$data['tanggal']."' where no_bukti='".$data['no_aju']."' and no_urut=".$nu." and kode_lokasi='$kode_lokasi' ";
                ...
                if($data['nu'] != $max['nu']){
                    ...
                    where a.no_bukti='".$data['no_aju']."' and a.no_urut=$nu and a.kode_lokasi='$kode_lokasi'";
                    ...
                    if(count($rs)>0){
                        ...
                        $content = "[Approval] Pengajuan Justifikasi Kebutuhan ".$data["no_aju"]." telah di approve oleh $nik , Menunggu approval anda.";
                    ...
                    $upd3 = "update apv_juskeb_m set progress ='".$data['status']."' where no_bukti='".$data['no_aju']."' and kode_lokasi='$kode_lokasi' ";
                    array_push($exec,$upd3);
                }else{
                    $upd3 = "update apv_juskeb_m set progress ='S' where no_bukti='".$data['no_aju']."' and kode_lokasi='$kode_lokasi'";
                    array_push($exec,$upd3);
                ...
                where a.no_bukti='".$data['no_aju']."' and a.kode_lokasi='$kode_lokasi' ";
                ...
                if(count($rs2)>0){
                    ...
                    $title = "Approval Pengajuan Justifikasi Kebutuhan";
                    $content = "[Approval] Pengajuan Justifikasi Kebutuhan ".$data["no_aju"]." anda telah di approve oleh $nik. ".$psn;
                ...
                $nu=$data['nu']-1;
                $upd2 = "update apv_flow set status ='1' ,tgl_app='-' where no_bukti='".$data['no_aju']."' and no_urut=".$nu." and kode_lokasi='$kode_lokasi' ";


                if(intval($data['nu']) != intval($min['nu'])){
                    ...
                    if(count($rs)>0){
                        ...
                        $title = "Approval Pengajuan Justifikasi Kebutuhan";
                        $content = "[Return] Pengajuan Justifikasi Kebutuhan ".$data["no_aju"]." telah di return oleh $nik";
                        $notif1 = sendNotif($title,$content,$token_player);
                        // $wa1 = sendWA($no_telp,$content);
                        // $psn = "Menunggu approval $nik_app1 ";
                        $exec_notif = array();
                    ...
                    $upd3 = "update apv_juskeb_m set progress ='B' where no_bukti='".$data['no_aju']."' and kode_lokasi='$kode_lokasi' ";
                    array_push($exec,$upd3);
                }else{
                    $upd3 = "update apv_juskeb_m set progress ='R' where no_bukti='".$data['no_aju']."' and kode_lokasi='$kode_lokasi' ";
                    array_push($exec,$upd3);
                }
                //send to nik buat
            ...
            $stswanotif = "Notif 1 = ".$notif1." Notif 2 = ".$notif2; //$nwa= " WA 1= ".$wa1."$no_telp WA 2 =".$wa2." $no_telp2";
    ...
    function getHistory(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            where a.kode_lokasi='$kode_lokasi' and a.modul='JK' and b.status IN ('2','3') and b.kode_jab='".$_SESSION['kode_jab']."' ";
    ...
    function getData2(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            from apv_flow a
            inner join apv_juskeb_m b on a.no_bukti=b.no_bukti and a.kode_lokasi=b.kode_lokasi
            left join apv_pesan c on a.no_bukti=c.no_bukti and a.kode_lokasi=c.kode_lokasi and a.no_urut=c.no_urut and c.modul='JK'
