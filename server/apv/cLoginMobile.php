<?php
        ...
        if($rs->RecordCount() > 0){
            try{
                ...
                if($rs2){
                    ...
                    header("Location: $root_app/apv_mainmobile/".$dash, true, 301);
                    // echo $root2."/fMain.php?hal=".$dash;
                    exit();
                }else{
                    echo "<script>alert('Error Login : ".$rs2."'); window.location='$root_app/apv_mobile';</script>";   
            ...
            echo "<script>alert('Username, password salah !'); window.location='$root_app/apv_mobile';</script>";
        }
    ...
    function logout(){
        ...
        $root_app=$_SERVER['REQUEST_SCHEME']."://".$_SERVER['SERVER_NAME'];
        $header="Location: $root_app/apv_mobile";
