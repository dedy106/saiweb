        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            if($data['status'] == 2){
                ...
                if($data['nu'] != $max['nu']){
                    ...
                    $upd3 = "update apv_juskeb_m set progress ='".$data['status']."' where no_bukti='".$data['no_aju']."' ";
                    array_push($exec,$upd3);
                }else{
                    $upd3 = "update apv_juskeb_m set progress ='S' where no_bukti='".$data['no_aju']."' ";
                    array_push($exec,$upd3);
                ...
                $upd3 = "update apv_juskeb_m set progress ='R' where no_bukti='".$data['no_aju']."' ";
                array_push($exec,$upd3);
            ...
            $stswanotif = "Notif 1 = ".$notif1." Notif 2 = ".$notif2." WA 1= ".$wa1."$no_telp WA 2 =".$wa2." $no_telp2";
