<?php
    ...
    function getPengajuan(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $kode_lokasi = $_GET['kode_lokasi'];
            $query .= "
            select a.no_bukti,a.no_dokumen,a.kode_pp,convert(varchar,a.waktu,103) as waktu,a.kegiatan,case a.progress when 'S' then 'FINISH' else isnull(b.nama_jab,'-') end as posisi,a.nilai,a.progress
            from apv_juskeb_m a
    ...
    function simpan(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            {	
                ...
                $body_text = "Pengajuan Justifikasi kebutuhan $no_bukti berhasil dikirim, menunggu approval $app_nik ";
