<?php
    ...
    function getJob(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            from sai_job_m a
            where a.kode_lokasi='$kode_lokasi' and a.nik='$nik' and a.progress in ('0','1') ";
    ...
    function getApproval(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $query .= "select a.kode_job,a.nama,a.no_proyek, a.nik,a.tgl_mulai,a.tgl_selesai, a.progress 
            from sai_job_m a
            where a.kode_lokasi='$kode_lokasi' and a.nik='$nik' and a.status='F' ";
    ...
    function getData(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            from sai_job_m a
            where a.kode_lokasi='$kode_lokasi' and a.kode_job='$id' and a.nik='$nik' and a.progress in ('0','1') ";
            $response["daftar"] = dbResultArray($sql);

            $sql="select kode_job,nu,nama,keterangan,status from sai_job_d where kode_lokasi='".$kode_lokasi."' and kode_job='$id'  and a.nik='$nik' and status='0' order by nu";
