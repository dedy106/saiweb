        ...
        if($rs->RecordCount() > 0){
            try{
                ...
                if($rs2){
                    ...
                    $_SESSION['exit_url']=$root_ser."/ajax/cLogin.php?fx=logout";
                    ...
                    header("Location: $root_app/ajax_main/".$dash, true, 301);
                    
                    exit();
                }else{
                    echo "<script>alert('Error Login : ".$rs2."'); window.location='$root_app/ajax';</script>";   
            ...
            echo "<script>alert('Username, password salah !'); window.location='$root_app/ajax';</script>";
        }
            ...
            try{
                ...
                if($rs2){
                    ...
                    if($row->path_view != null || $row->path_view != "-" ){
                        ...
                        $dash="";
                        // header("Location: $root_app/ajax/dashboard.php".$dash, true, 301);
