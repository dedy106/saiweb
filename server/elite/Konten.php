<?php
    ...
    function getKonten(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'],$_SESSION['userPwd'])){
            ...
            $query .= "select convert(int, no_konten) as no_konten, judul, flag_aktif, jenis, convert(varchar, tanggal, 106) as tanggal from sai_konten 
            where kode_lokasi= '".$kode_lokasi."'  ";

            $column_array = array('no_konten','judul','flag_aktif','jenis','tanggal');
            $order_column = 'ORDER BY convert(int, no_konten) as no_konten '.$data['order'][0]['dir'];
    ...
    function getEditData(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'],$_SESSION['userPwd'])){
            ...
            $sql="select no_konten, convert(varchar, tanggal, 105) as tanggal, judul, isi, file_gambar,kode_kategori,tag,jenis,tipe from sai_konten where kode_lokasi='".$_POST['lokasi']."' and no_konten='$id' ";
