<?php
        ...
        if($rs->RecordCount() > 0){
            try{
                ...
                if($rs2){
                    ...
                    $_SESSION['exit_url']=$root_ser."/sakuaja/cLogin.php?fx=logout";
                    ...
                    if($row->path_view != null || $row->path_view != "-" ){
                        ...
                        $dash="";
                        // header("Location: $root_app/elite/dashboard.php".$dash, true, 301);
                        
                    }
                   
                    
                    header("Location: $root_app/elite_main/".$dash, true, 301);
                    // echo $root2."/fMain.php?hal=".$dash;
                    exit();
                }else{
                    echo "<script>alert('Error Login : ".$rs2."'); window.location='$root_app/elite';</script>";   
            ...
            echo "<script>alert('Username, password salah !'); window.location='$root_app/elite';</script>";
        }
    ...
    function logout(){
        ...
        $root_app="http://".$_SERVER['SERVER_NAME'];
        $header="Location: $root_app/elite";
