		...
		if($jum > 0){
            try{
                ...
                if($rs2){
                    ...
                    $_SESSION['exit_url']=$root_ser."/dash/cLogin.php?fx=logout";
                    setcookie('exit_url', $root_ser."/dash/cLogin.php?fx=logout", time() + (86400 * 0.5), "/");	
                    ...
                    header("Location: $root_app/dash_main/".$dash, true, 301);
                    // echo $root2."/fMain.php?hal=".$dash;
                    exit();
                }else{
                    echo "<script>alert('Error Login : ".$rs2."'); window.location='$root_app/dash';</script>";   
            ...
            echo "<script>alert('Username, password salah !'); window.location='$root_app/dash';</script>";
        }
