<?php
    ...
    function login(){
        ...
        $sql="
        select a.kode_menu_lab as kode_klp_menu, a.nik, a.nama, a.pass, a.status_admin, a.klp_akses, a.kode_lokasi,b.nama as nmlok, c.kode_pp,d.nama as nama_pp,
                    b.kode_lokkonsol,d.kode_bidang, c.foto,isnull(e.form,'-') as path_view,b.logo,c.email
                from hakakses a 
        ...
        if($rs->RecordCount() > 0){
            try{
                ...
                if($rs2){
                    ...
                    $_SESSION['exit_url']=$root_ser."/siswa/cLoginSekolah.php?fx=logout";
                    ...
                    if($row->path_view != null || $row->path_view != "-" ){
                        ...
                        $dash="";
                        // header("Location: $root_app/esaku/dashboard.php".$dash, true, 301);
                        
                    }
                   
                    
                    header("Location: $root_app/sekolah_main/".$dash, true, 301);
                    // echo $root2."/fMain.php?hal=".$dash;
                    exit();
                }else{
                    echo "<script>alert('Error Login : ".$rs2."'); window.location='$root_app/sekolah';</script>";   
            ...
            echo "<script>alert('Username, password salah !'); window.location='$root_app/sekolah';</script>";
        }
    ...
    function logout(){
        ...
        $root_app=$_SERVER['REQUEST_SCHEME']."://".$_SERVER['SERVER_NAME'];
        $header="Location: $root_app/sekolah";
