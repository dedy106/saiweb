<?php
    ...
    function getRole(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $kode_lokasi = $_GET['kode_lokasi'];
            $query .= "
            select a.kode_role,a.nama,a.kode_pp,a.bawah,a.atas
            from apv_role a
            where a.kode_lokasi='".$kode_lokasi."'  ";

            $column_array = array('a.kode_role','a.kode_pp','a.nama','a.bawah','a.atas');
    ...
    function getEdit(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $sql="select kode_role,kode_pp,nama,bawah,atas from apv_role where kode_lokasi='".$_GET['kode_lokasi']."' and kode_role='$id' ";
    ...
    function simpan(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
                ...
                if($sts){
                    ...
                    $sql1= "insert into apv_role (kode_role,kode_pp,nama,bawah,atas,kode_lokasi) values ('".$kode_role."','".$data['kode_pp']."','".$data['nama']."',".joinNum($data['bawah']).",".joinNum($data['atas']).",'".$data['kode_lokasi']."') ";
