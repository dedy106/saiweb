<?php
		...
		if($jum > 0){
            try{
                ...
                if($rs2){
                    ...
                    $_SESSION['exit_url']=$root_ser."/sakube/cLogin.php?fx=logout";
                    ...
                    // header("Location: $root_app/sakube_main/".$dash, true, 301);
                    ...
                    echo json_encode($response);
                    // echo "<script>alert('Error Login : ".$rs2."'); window.location='$root_app/sakube';</script>";   
            ...
            echo json_encode($response);
            // echo "<script>alert('Username, password salah !'); window.location='$root_app/sakube';</script>";
        }
    ...
    function logout(){
        ...
        $root_app="http://".$_SERVER['SERVER_NAME'];
        $header="Location: $root_app/sakube";
