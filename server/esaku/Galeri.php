<?php
    ...
    function getGaleri(){
        ...
        $query .= "select id, nama, jenis from sai_konten_galeri where kode_lokasi= '".$kode_lokasi."'  ";
    ...
    function simpanGaleri(){
        ...
        // if(ISSET($_FILES["file_gambar"]["name"])){
            ...
            $target_dir = $path_s."web/upload/sakuaja/";
            ...
            $filepath="/upload/sakuaja/".basename($_FILES["filename"]["name"]);
    ...
    function hapusGaleri(){
        ...
        $fullpath=$pathini."web/".$tmp[0].$tmp[1]."/".$tmp[2]."/".$tmp[3];
