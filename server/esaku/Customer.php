<?php
    ...
    function getCustomer(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'],$_SESSION['userPwd'])){
            ...
            // $query .= "select kode_cust, nama, alamat, pic, no_telp, email, gambar from sai_cust 
            // where kode_lokasi= '".$kode_lokasi."'  ";
            $query .= "select kode_cust, nama, alamat, pic, no_telp, email, gambar from sai_cust 
            where kode_lokasi= '11'  ";

            $column_array = array('kode_cust','nama','alamat','pic','no_telp','email','gambar');
    ...
    function getEditData(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'],$_SESSION['userPwd'])){
            ...
            $sql="select kode_cust, nama, alamat, pic, no_telp, email, gambar from sai_cust where kode_lokasi='11' and kode_cust='$id' ";
...
// echo "Format: $format; " . $date->format('Y-m-d H:i:s') . "\n";
    ...
    function updateKonten(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'],$_SESSION['userPwd'])){
            ...
            $sql1="update sai_cust set nama='".$data['nama']."',alamat='".$data['alamat']."',pic='".$data['pic']."',no_telp='".$data['no_telp']."',email='".$data['email']."',gambar='".$data['gambar']."',flag_aktif='1' where kode_cust = '".$data['id']."' and kode_lokasi='".$data['kode_lokasi']."' ";
