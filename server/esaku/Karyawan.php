<?php
    ...
    function getKaryawan(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'],$_SESSION['userPwd'])){
            ...
            $query .= "select nik, nama, no_telp, email, foto from sai_karyawan 
            where kode_lokasi= '99'  ";

            $column_array = array('nik','nama','no_telp','email','foto');
    ...
    function getEditData(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'],$_SESSION['userPwd'])){
            ...
            $sql="select nik, nama, no_telp, email, foto from sai_karyawan where kode_lokasi='99' and nik='$id' ";
