<?php
        ...
        if($rs->RecordCount() > 0){
            try{
                ...
                if($rs2){
                    ...
                    $_SESSION['exit_url']=$root_ser."/esaku/cLogin.php?fx=logout";
                    ...
                    header("Location: $root_app/esaku-admin_main/".$dash, true, 301);
                    // echo $root2."/fMain.php?hal=".$dash;
                    exit();
                }else{
                    echo "<script>alert('Error Login : ".$rs2."'); window.location='$root_app/esaku-admin';</script>";   
            ...
            echo "<script>alert('Username, password salah !'); window.location='$root_app/esaku-admin';</script>";
        }
    ...
    function logout(){
        ...
        $root_app=$_SERVER['REQUEST_SCHEME']."://".$_SERVER['SERVER_NAME'];
        $header="Location: $root_app/esaku-admin";
