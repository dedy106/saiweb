<?php
    ...
    function kirim_email($email,$user,$body_text){
        try{
            ...
            // Create a message
            $message = Swift_Message::newInstance('Laporan Daftar Peserta')
    ...
    function getLap(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $col_array = array('no_peserta','jk');
            $db_col_name = array('a.no_peserta','a.jk');
            $where = "";
            ...
            $sql="select a.no_peserta,a.nama,a.jk,a.telp,a.hp, a.alamat from dgw_peserta a
    ...
    function getPeserta(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $sql="select distinct no_peserta,nama from dgw_peserta where kode_lokasi='$kode_lokasi' ";
    ...
    function getJK(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            if($data['no_peserta'] == ""){
                ...
                $filter = " and a.no_peserta='".$data['no_peserta']."' ";
            }
