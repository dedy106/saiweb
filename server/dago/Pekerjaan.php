<?php
    ...
    function getView(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $query .= "select id_pekerjaan,nama from dgw_pekerjaan where kode_lokasi='".$kode_lokasi."'  ";

            $column_array = array('id_pekerjaan','nama');
            $order_column = 'ORDER BY id_pekerjaan '.$_GET['order'][0]['dir'];
    ...
    function getEdit(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $sql="select id_pekerjaan,nama from dgw_pekerjaan where kode_lokasi='".$_GET['kode_lokasi']."' and id_pekerjaan='$id' ";
