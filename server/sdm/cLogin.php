        ...
        if($rs->RecordCount() > 0){
            try{
                ...
                if($rs2){
                    ...
                    $_SESSION['exit_url']=$root_ser."/sdm/cLogin.php?fx=logout";
                    ...
                    if($row->path_view != null || $row->path_view != "-" ){
                        ...
                        $dash="";
                        // header("Location: $root_app/sdm/dashboard.php".$dash, true, 301);
                        
                    }
                   
                    
                    header("Location: $root_app/sdm_main/".$dash, true, 301);
                    // echo $root2."/fMain.php?hal=".$dash;
                    exit();
                }else{
                    echo "<script>alert('Error Login : ".$rs2."'); window.location='$root_app/sdm';</script>";   
            ...
            echo "<script>alert('Username, password salah !'); window.location='$root_app/sdm';</script>";
        }
