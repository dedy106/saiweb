...
<body class="skin-default fixed-layout">
    ...
    <!-- Editable -->
    <script src="<?=$folder_assets?>/node_modules/jquery-datatables-editable/jquery.dataTables.js"></script>
    <!-- <script src="<?=$folder_assets?>/node_modules/datatables/media/js/dataTables.bootstrap.js"></script> -->
    <script src="<?=$folder_assets?>/node_modules/tiny-editable/mindmup-editabletable.js"></script>
    <script src="<?=$folder_assets?>/node_modules/tiny-editable/numeric-input-example.js"></script>
    <script>
