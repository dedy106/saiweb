		...
		if($jum > 0){
            try{
                ...
                if($rs2){
                    ...
                    $_SESSION['exit_url']=$root_ser."/saku/cLogin.php?fx=logout";
                    // setcookie('exit_url', $root_ser."/saku/cLogin.php?fx=logout", time() + (86400 * 0.5), "/");	
                    ...
                    if($row->path_view != null || $row->path_view != "-" ){
                        ...
                        $dash="";
                        // header("Location: $root_app/saku/dashboard.php".$dash, true, 301);
                        
                    }
                   
                    //echo "$root_app/saku/dashboard.php".$dash;
                    header("Location: $root_app/saku_main/".$dash, true, 301);
                    // echo $root2."/fMain.php?hal=".$dash;
                    exit();
                }else{
                    echo "<script>alert('Error Login : ".$rs2."'); window.location='$root_app/saku';</script>";   
            ...
            echo "<script>alert('Username, password salah !'); window.location='$root_app/saku';</script>";
        }
