<?php
    ...
    function getView(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $query .= "select a.kode_flag,a.nama from flag_akun a ";

            $column_array = array('a.kode_flag','a.nama');
            $order_column = 'ORDER BY a.kode_flag '.$_GET['order'][0]['dir'];
