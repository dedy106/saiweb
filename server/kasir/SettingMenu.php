    ...
    function getMenu(){
        ...
        if($daftar != null){
            ...
            for($i=0; $i<count($daftar); $i++){
                ...
                <td class='set_link'>".$daftar[$i]['kode_form']."<input type='hidden' name='kode_form[]' value='".$daftar[$i]['kode_form']."'><input type='hidden' class='set_icon' name='icon[]' value='".$daftar[$i]['icon']."'></td>
