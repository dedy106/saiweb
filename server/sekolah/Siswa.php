<?php
    ...
    function getView(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $query .= "select a.nis,a.nama,a.kode_kelas,a.kode_akt,a.kode_pp from sis_siswa a
            where a.kode_lokasi='$kode_lokasi'";

            $column_array = array('a.nis','a.nama','a.kode_kelas','a.kode_akt','a.kode_pp');
            $order_column = 'ORDER BY a.nis '.$_GET['order'][0]['dir'];
