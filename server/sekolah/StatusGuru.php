<?php
    ...
    function getView(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $query .= "select kode_status, nama from sis_guru_status where kode_lokasi='".$kode_lokasi."' and kode_pp='$kode_pp'";

            $column_array = array('kode_status','nama');
            $order_column = 'ORDER BY kode_status '.$_GET['order'][0]['dir'];
