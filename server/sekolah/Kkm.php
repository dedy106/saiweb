<?php
    ...
    function getView(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $query .= "select a.kode_kkm, a.kode_ta,a.kode_tingkat,a.kode_jur from sis_kkm a where a.kode_lokasi='".$kode_lokasi."' and a.kode_pp='$kode_pp' group by a.kode_kkm,kode_ta,a.kode_tingkat,a.kode_jur ";

            $column_array = array('a.kode_kkm','a.kode_ta','a.kode_tingkat','a.kode_jur');
