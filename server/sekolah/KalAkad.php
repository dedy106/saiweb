<?php
    ...
    function getView(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $query .= "select tanggal,agenda,kode_sem,kode_ta from sis_kalender_akad where kode_lokasi='$kode_lokasi' and kode_pp='$kode_pp'";

            $column_array = array('tanggal','agenda','kode_sem','kode_ta');
            $order_column = 'ORDER BY tanggal '.$_GET['order'][0]['dir'];
