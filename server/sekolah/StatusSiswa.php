<?php
    ...
    function getView(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $query .= "select kode_ss, nama, flag_aktif from sis_siswa_status  where kode_lokasi='".$kode_lokasi."' and kode_pp='$kode_pp'";

            $column_array = array('kode_ss','nama','flag_aktif');
            $order_column = 'ORDER BY kode_ss '.$_GET['order'][0]['dir'];
