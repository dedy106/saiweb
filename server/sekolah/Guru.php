<?php
    ...
    function getView(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $query .= "select distinct a.nik,a.nama from sis_guru_matpel b inner join karyawan a on a.nik=b.nik and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp where a.kode_lokasi='".$kode_lokasi."' and a.kode_pp='$kode_pp'";

            $column_array = array('a.nik','a.nama');
