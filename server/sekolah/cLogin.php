		...
		if($jum > 0){
            try{
                ...
                if($rs2){
                    ...
                    $_SESSION['exit_url']=$root_ser."/sekolah/cLogin.php?fx=logout";
                    // setcookie('exit_url', $root_ser."/sekolah/cLogin.php?fx=logout", time() + (86400 * 0.5), "/");	
                    ...
                    if($row->path_view != null || $row->path_view != "-" ){
                        ...
                        $dash="";
                        // header("Location: $root_app/sekolah/dashboard.php".$dash, true, 301);
                        
                    }
                   
                    //echo "$root_app/sekolah/dashboard.php".$dash;
