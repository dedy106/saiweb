<?php
    ...
    function getView(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $query .= "select kode_ta,nama,convert (varchar, tgl_mulai,103) as tgl_mulai,convert (varchar, tgl_akhir,103) as tgl_akhir, case when flag_aktif='1' then 'AKTIF' else 'NONAKTIF' end as sts
            from sis_ta where kode_lokasi='$kode_lokasi'  and kode_pp='$kode_pp'";

            $column_array = array('kode_ta','nama','convert (varchar, tgl_mulai,103)','convert (varchar, tgl_akhir,103)','flag_aktif');
            $order_column = 'ORDER BY kode_ta '.$_GET['order'][0]['dir'];
