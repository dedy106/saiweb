<?php
    ...
    function getView(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $query .= "select kode_matpel, nama from sis_matpel where kode_lokasi='".$kode_lokasi."' and kode_pp='$kode_pp'";

            $column_array = array('kode_matpel','nama');
            $order_column = 'ORDER BY kode_matpel '.$_GET['order'][0]['dir'];
