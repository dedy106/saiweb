<?php
    ...
    function getView(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $query .= "select kode_slot, nama from sis_slot where kode_lokasi='".$kode_lokasi."' and kode_pp='$kode_pp'";

            $column_array = array('kode_slot','nama');
            $order_column = 'ORDER BY kode_slot '.$_GET['order'][0]['dir'];
