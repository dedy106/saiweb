<?php
    ...
    function getView(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){
            ...
            $query .= "select kode_jur,nama,kode_pp from sis_jur where kode_lokasi='".$kode_lokasi."' and kode_pp='$kode_pp'";

            $column_array = array('kode_jur','nama','kode_pp');
            $order_column = 'ORDER BY kode_jur '.$_GET['order'][0]['dir'];
