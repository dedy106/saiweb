		...
		if($jum > 0){
            try{
                ...
                if($rs2){
                    ...
                    $_SESSION['exit_url']=$root_ser."/cms/cLogin.php?fx=logout";
                    ...
                    header("Location: $root_app/cms_main/".$dash, true, 301);
                    // echo $root2."/fMain.php?hal=".$dash;
                    exit();
                }else{
                    echo "<script>alert('Error Login : ".$rs2."'); window.location='$root_app/cms';</script>";   
            ...
            echo "<script>alert('Username, password salah !'); window.location='$root_app/cms';</script>";
        }
