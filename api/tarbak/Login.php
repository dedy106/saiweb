<?php
    ...
    function getKoneksi(){
        ...
        include_once($root."lib/koneksi6.php");
    ...
    function login(){
        ...
        if($cek['kode_menu'] == "SISWAWEB" OR $cek['kode_menu'] == "SISWA" OR $cek['kode_menu'] == "SISWA_APV"){
    ...
    function getDaftarPP(){	
        getKoneksi();
		$nik = $_POST['nis'];
		$sql = "SELECT a.kode_pp,a.nama from pp a left join sis_hakakses b on a.kode_pp = b.kode_pp where a.kode_lokasi = '01' and b.nik='$nik' order by a.kode_pp";
        $rs = execute($sql);
        if($rs->RecordCount() > 0){
